  ...
  async interaction => {
    ...
    try {
      ...
      if (interaction.isButton() && interaction.customId.startsWith("profile:")) {
        ...
        return interaction.update({ embeds: [page.embed], files: page.files, components: [row] });
      }
      ...
      if (
        ...
        await interaction.editReply({ embeds: [page.embed], files: page.files, components: [row] });
